...
from ...utils.custom_annotations_parser import parse_custom_annotations
...
def parse(self, exclusive = False):
    ...
    # TODO(kolja): Swap parser with own impl.
    # dumps = pascal_voc_clean_xml(ann, meta['labels'], exclusive)
    dumps = parse_custom_annotations(ann, meta['labels'], exclusive)
    return dumps
